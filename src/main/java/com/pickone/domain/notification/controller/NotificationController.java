...
public class NotificationController {
  ...
  public ResponseEntity<BaseResponse<NotificationDto>> sendNotification(
    ...
    log.info("알림 전송 요청: recipientId={}, type={}, title={}", recipientId, type, title);
    NotificationDocument doc = notificationService.sendNotification(recipientId, type, title,
        content);
  ...
  public ResponseEntity<BaseResponse<List<NotificationDto>>> getNotifications(
      @RequestParam Long recipientId) {
    log.info("알림 목록 조회 요청: recipientId={}", recipientId);
  ...
  public ResponseEntity<BaseResponse<List<NotificationDto>>> getUnread(
      @RequestParam Long recipientId) {
    log.info("읽지 않은 알림 조회 요청: recipientId={}", recipientId);
  ...
  public ResponseEntity<BaseResponse<Void>> deleteAll(@PathVariable Long recipientId) {
    log.info("사용자 알림 전체 삭제 요청: recipientId={}", recipientId);
