package com.pickone.domain.consent.model.processor;
...
public class ConsentAgreementProcessor {
  ...
  public List<ConsentEntity> toEntities(UserEntity user, List<ConsentRequestDto> agreementDtos) {
    // 필수 약관 ID 목록 확보
    ...
    Map<Long, ConsentRequestDto> agreementMap = agreementDtos.stream()
        .collect(Collectors.toMap(ConsentRequestDto::termId, Function.identity()));
